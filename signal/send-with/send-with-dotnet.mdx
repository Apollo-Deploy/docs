...
description: "Send a transactional email from .NET using HttpClient"
---
...
Set `SIGNAL_API_KEY` in your secret provider and inject an `HttpClient` into the service.
  </Step>
...
client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue(
    "Bearer",
    Environment.GetEnvironmentVariable("SIGNAL_API_KEY")
);

var response = await client.PostAsJsonAsync(
    "https://api.signal.apollodeploy.com/v1/emails",
    new
    {
