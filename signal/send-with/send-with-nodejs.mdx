...
description: "Send a transactional email from a Node.js server using the Apollo Signal REST API"
---
...
Node.js 18 and later include `fetch`, so you do not need an Apollo-specific package.
Keep `SIGNAL_API_KEY` in the server environment and never expose it to browser code.
  </Step>
