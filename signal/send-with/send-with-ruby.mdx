...
description: "Send a transactional email from Ruby using Net::HTTP"
---
...
Set `SIGNAL_API_KEY` in the environment available to your Ruby application.
  </Step>
...
uri = URI("https://api.signal.apollodeploy.com/v1/emails")
